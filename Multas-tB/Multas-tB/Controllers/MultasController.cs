...
namespace Multas_tB.Controllers {
   public class MultasController : Controller {
      ...
      public ActionResult Create([Bind(Include = "ID,Infracao,LocalDaMulta,ValorMulta,DataDaMulta,CondutorFK,ViaturaFK,AgenteFK")] Multas multas) {
      ...
      [HttpPost]
      [ValidateAntiForgeryToken]
      public ActionResult Edit([Bind(Include = "ID,Infracao,LocalDaMulta,ValorMulta,DataDaMulta,CondutorFK,ViaturaFK,AgenteFK")] Multas multas) {
         if(ModelState.IsValid) {
